...
from cl_load_data import perMyDataset as MyDataset
import os
import sys
sys.path.append('../..')
...
def args_parse():
    ...
    parser.add_argument('--split_num', type=int, default=21)
...
def main():
    ...
    baseModel = torch.load('./savedModels/per_CMSC_CPSC2018.pth', map_location=device)
    classifer_model = downStreamClassifier(baseModel, num_classes=2)

import sys
sys.path.append('..')
from Multiview.DiffusionModels.utils._2DnetworkHelper import *
from Multiview.DiffusionModels.diffusionModels.Diffusion._2DvarianceSchedule import VarianceSchedule
...
class DiffusionModel(nn.Module):
    ...
    def forward(self, mode, **kwargs):
        if mode == "train":
            ...
            raise ValueError("mode must be one of 'train', 'generate', 'feature_extractor'")

...
class TrainerBase(nn.Module):
    def __init__(self,
        ...
        if self.device is None:
            raise ValueError("Expected device but got None")
        ...
        if IFadjust_learning_rate:
            if "types" in kwargs.keys():
                ...
                raise ValueError("Types is required for adjust learning rate")
    ...
    def adjust_learning_rate(self, epoch, learning_rate):
        ...
        if self.types == 'type1':
            ...
            raise ValueError("Please choose {{0}or{1}} types".format("type1", "type2"))
...
class SimpleDiffusionTrainer(TrainerBase):
    def __init__(self,
        ...
        if "timesteps" in kwargs.keys():
            ...
            raise ValueError("Timesteps is required for SimpleDiffusionTrainer")
